...
public class Remove extends JFrame implements ActionListener{
    ...
    Remove(){
        ...
        try {
            conn c = new conn();
            ResultSet resultSet = c.statement.executeQuery("select * from e where empId = '"+ChoiceEmpid.getSelectedItem()+"'");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==delete){
            try{
                conn c = new conn();
                String query = "delete from e where empid = '"+ChoiceEmpid.getSelectedItem()+"'";
